        ...
        <>
          ...
          >
            ...
            >
              ...
              >
                {item.model}
                {item.subCategory === 'fragrance' ? ` ${t('for')} ` : ','} {item.type && `${item.type}, `}
                {` ${item[item.optionKey]}`}
              ...
              {salePercent && (
                ...
                >
                  {t('lastPrice')}: {item.previousPrice.toLocaleString()}
                </Typography>
              )}
              ...
              {togetherItems && togetherItems[0] && (
                ...
                >
                  ...
                  >
                    ...
                    >
                      <strong> {t('thisItem')}: </strong> {item.fullName}
                    </Typography>
                    <Typography
                      sx={{
                        color: '#e52b2bff',
