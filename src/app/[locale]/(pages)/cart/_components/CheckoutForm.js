...
export default function CheckoutForm({
  ...
  const shippingMethodObj = {
    free: {
      type: t('freeShipping'),
      deliveryDuration: t('deliveryDays', { days: '1-3' }),
      icon: <DirectionsBikeIcon sx={{ fontSize: '20px', mr: '8px' }} />,
      price: '֏0',
      description: t('shippingDescFree'),
    },
    standart: {
      type: t('standardShipping'),
      deliveryDuration: t('deliveryDays', { days: '1-3' }),
      icon: <LocalShippingOutlinedIcon sx={{ fontSize: '20px', mr: '8px' }} />,
      price: '֏1000',
      description: t('shippingDescStandard'),
    },
    express: {
      type: t('expressShipping'),
      deliveryDuration: t('deliveryDay', { days: '1' }),
      icon: <RocketLaunchOutlinedIcon sx={{ fontSize: '20px', mr: '8px' }} />,
      price: '֏3000',
      description: t('shippingDescExpress'),
    },
  };
  ...
  return (
    <>
      <Box sx={{ display: 'flex', alignItems: 'center', mb: '30px' }}>
        ...
        <Typography sx={{ fontWeight: 500, fontSize: '18px' }}>{t('contactInfo')}</Typography>
      </Box>
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', mt: '35px', mb: '15px' }}>
        ...
        <Typography sx={{ fontWeight: 500, fontSize: '18px' }}>{t('shippingMethod')}</Typography>
      </Box>
      <Box sx={{ display: 'flex', flexWrap: 'wrap' }}>
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', mt: '35px', mb: '15px' }}>
        ...
        <Typography sx={{ fontWeight: 500, fontSize: '18px' }}>{t('paymentMethod')}</Typography>
      </Box>
      <Box sx={{ display: 'flex', flexWrap: 'wrap' }}>
        <Box
        ...
        >
          ...
          >
            ...
            <Box sx={{ display: 'flex', justifyContent: 'space-between', flexGrow: 1, flexWrap: 'wrap' }}>
              <Typography>{t('payWithCard')}</Typography>
        ...
        >
          ...
          >
            ...
            <Box sx={{ display: 'flex', justifyContent: 'space-between', flexGrow: 1, flexWrap: 'wrap' }}>
              <Typography>{t('payWithCash')}</Typography>
