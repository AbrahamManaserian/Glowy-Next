...
export default function SpecialOffer() {
  return (
    <Grid sx={{ m: { xs: '80px 15px', sm: '90px 25px' } }} size={12} container justifyContent="center">
      <Typography
        sx={{ fontSize: { xs: '22px', sm: '32px' }, mb: '20px', flexGrow: 1, width: '100%' }}
        fontWeight={700}
        color="#2B3445"
      >
        Special Offer
      </Typography>
      <Grid size={12} maxWidth={'1150px'} spacing={1} container>
        <Grid
        ...
        >
          ...
          <Typography sx={{ color: '#2B3445', fontSize: '18px', fontWeight: 500, mt: '5px' }}>
...
function DealCountdown() {
  ...
  useEffect(() => {
    ...
    const dealEndTime = new Date().getTime() + 1 * 24 * 60 * 60 * 1000;
